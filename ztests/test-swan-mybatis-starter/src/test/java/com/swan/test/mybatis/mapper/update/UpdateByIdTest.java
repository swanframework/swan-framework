...
public class UpdateByIdTest extends BaseAutoMapperTest {
    ...
    public void autoMapper(){
        ...
        demo.setName("lisi");
        demo.setAge(null);
        boolean updateSuccess = this.autoMapper.updateById(demo);
    ...
    public void autoVersionMapper(){
        ...
        demo.setName("lisi");
        demo.setAge(30);
        boolean updateSuccess = this.autoVersionMapper.updateById(demo);
        Assertions.assertTrue(updateSuccess);

        AutoVersionEntity entity = this.autoVersionMapper.selectById(demo.getId());
        Assertions.assertEquals("lisi", entity.getName());
        Assertions.assertEquals(30, entity.getAge().intValue());
        Assertions.assertNotNull(entity.getVersion());

        entity.setName("wangwu");
        entity.setAge(null);
        entity.setVersion(1000);
        boolean update = this.autoVersionMapper.updateById(entity);
    ...
    public void autoDelVersionMapper(){
        ...
        demo.setName("lisi");
        demo.setAge(30);
        boolean updateSuccess = this.autoDelVersionMapper.updateById(demo);
        Assertions.assertTrue(updateSuccess);
        ...
        entity.setAge(null);
        entity.setVersion(1000);
        boolean update = this.autoDelVersionMapper.updateById(entity);
        Assertions.assertTrue(update);

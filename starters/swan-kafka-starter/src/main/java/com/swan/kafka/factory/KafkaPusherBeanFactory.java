...
import com.swan.kafka.reflect.KafkaMethodInvoker;
 ...
 * @since 2020-09-07
 */
public class KafkaPusherBeanFactory extends BaseFactoryBean {
    ...
    public Object getObject() throws Exception {
        ...
        for (Method declaredMethod : type.getMethods()) {
            ...
            if (Object.class.equals(declaredMethod.getDeclaringClass())) {
                ...
                IMethodInvoker methodInvoker = new KafkaMethodInvoker(this.applicationContext.getBean(KafkaTemplate.class));
                methodInvokerMap.put(declaredMethod, methodInvoker);
            }
        }
